...
public class VerticalAdapter extends RecyclerView.Adapter<VerticalAdapter.FoodViewHolder> {

    List<FoodMenu> foodMenuList;

    public VerticalAdapter(List<FoodMenu> foodMenuList) {
    ...
    @NonNull
    @Override
    public VerticalAdapter.FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemview = LayoutInflater.from(parent.getContext()).inflate(R.layout.mylistitem,parent,false);
        return new FoodViewHolder(itemview);
    }

    @Override
    public void onBindViewHolder(@NonNull VerticalAdapter.FoodViewHolder holder, int position) {
